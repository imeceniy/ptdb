...
namespace DataGrabber
{
    ...
    /// </summary>
    public class DataSection_rep : IEnumerable<KeyValuePair<string, double>>
    {
        public double Rx;
        public double dR;
        public double Qa;
        ...
        /// <returns></returns>
        public static DataSection_rep Create(string rx, string dR, string qa, string dl, string ppCu, string rk,
            string umin1, string umin3, string dck1)
        {
        ...
        {
            var fields = typeof(DataSection_rep).GetFields();
